...
class ScheduledDonationResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'locked' =>  !$this->user()->is($request->user('sanctum')),
            'paused_at' => $this->paused_at,
            'deleted_at' => $this->deleted_at,
            'destination' => $destination,
            'frequency' => ScheduledDonation::DONATION_FREQUENCY_MAP[$this->frequency] ?? null,
            'start_date' => $this->start_date ? date_format($this->start_date, 'Y-m-d') : null,
            'tip' => $this->tip / 100,
