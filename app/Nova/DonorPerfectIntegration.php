...
class DonorPerfectIntegration extends Resource
{
    /**
     ...
     * @var string
     */
    public static $model = \App\Models\DonorPerfectIntegration::class;
    ...
    public function fields(Request $request)
    {
        return [
            ...
            Text::make('Api Key')->nullable()->rules('nullable', 'max:191'),
